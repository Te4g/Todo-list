 ...
 */
final class Version20191205172451 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE todo ADD user_id INT NOT NULL, CHANGE is_completed is_completed TINYINT(1) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE todo DROP user_id, CHANGE is_completed is_completed TINYINT(1) DEFAULT \'0\'');
    }
}
